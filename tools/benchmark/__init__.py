"""tools.benchmark — cross-model KPI leaderboard for the KDB kdb_graph_compiler.

Separate from the production packages by design: imports from common (types,
call_model, llm_telemetry) and kdb_graph_compiler (kpi) but is never imported by them,
