...
`~/Droidoes/Code-projects/youtube-comment-chat/src/eval/models.json`:
    ...
    Required:
      ...
      provider    — SDK route: anthropic | openai | gemini | xai | alibaba | deepseek | ollama-local | ollama-cloud
...
class ModelEntry:
    ...
    provider: str             # anthropic | openai | gemini | xai | alibaba | deepseek | ollama-local | ollama-cloud
