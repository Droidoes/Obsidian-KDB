...
# kdb_graph_compiler's body_wikilink_slugs and the graph intake mirror (heading
...
def _remap_body_wikilinks(
    ...
    not links (same token semantics as the kdb_graph_compiler/graph extractors) and
