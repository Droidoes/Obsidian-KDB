...
Run E.2 (in normal suite):
    python3 -m pytest kdb_graph_compiler/tests/test_t2_end_to_end_pass1_path.py::test_pass2_plumbing_on_empty_context_state_c
"""
from __future__ import annotations

import json

from kdb_graph_compiler.prompt_builder import build_prompt
