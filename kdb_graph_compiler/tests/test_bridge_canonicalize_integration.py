...
from kdb_graph_compiler import canonicalize
from kdb_graph_compiler.canonicalize import AliasEntry, AliasLedger
from kdb_graph_compiler.proposal_bridge import BridgeSuccess, normalize_proposal


def _ledger(*pairs: tuple[str, str]) -> AliasLedger:
    """In-memory ledger — same pattern as kdb_graph_compiler/tests/test_canonicalize_algorithm.py:41."""
    return AliasLedger(
