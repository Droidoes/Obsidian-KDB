...
To run:
    ANTHROPIC_API_KEY=... KDB_RUN_LIVE_API=1 \\
        .venv/bin/python3 -m pytest kdb_graph_compiler/tests/test_m2_first_compile.py -s

This is the "green-light" milestone per blueprint §14.6: the first
evidence that the entire M2 stack (kdb_graph_compiler → prompt_builder → call_model
...
from kdb_graph_compiler import compiler, validate_source_response
