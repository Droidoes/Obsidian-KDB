...
from kdb_graph_compiler.page_writer import (
    ApplyResult,
    PagePatch,
    PagePatchError,
    apply,
...
def test_emit_frontmatter_null_and_bool_scalars() -> None:
    ...
    from kdb_graph_compiler.page_writer import _yaml_scalar
...
def test_render_page_roundtrip_frontmatter() -> None:
    from kdb_graph_compiler.page_writer import _scan_source_meta
