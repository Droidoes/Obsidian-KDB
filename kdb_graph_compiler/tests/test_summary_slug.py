"""Tests for kdb_graph_compiler.summary_slug — the centralized expected_summary_slug (#115, Task 1.4)."""
...
from kdb_graph_compiler.summary_slug import STEM_BUDGET, expected_summary_slug
