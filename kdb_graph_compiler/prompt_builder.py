...
The prompt has two halves:
  ...
  system — the KDB kdb_graph_compiler system prompt (the LLM's full invariants
           doc, packaged in the repo at kdb_graph_compiler/prompts/ post-#115 —
...
def load_system_prompt() -> str:
    """Read the repo-packaged kdb_graph_compiler system prompt
    (`kdb_graph_compiler/prompts/KDB-Compiler-System-Prompt.md`, post-#115). Cached —
