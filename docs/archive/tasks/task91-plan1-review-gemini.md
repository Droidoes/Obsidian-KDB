...
*   **Evidence:** `docs/superpowers/archive/specs/2026-05-28-kdb-orchestrate-e2e-design.md` §171: `"6 canonicalize | compiler core (per-source; not cross-source-batch-bound)"`.
...
*   **Evidence:** `docs/superpowers/archive/plans/2026-05-29-task91-plan1-kdb-compile-rebuild.md` lines 483–490: `apply_result = patch_applier.apply(...)` is called inside `compile_source`. `docs/task91-kdb-orchestrate-blueprint.md` §D-91-13 (two-phase failure).
...
*   **Evidence:** `docs/superpowers/archive/plans/2026-05-29-task91-plan1-kdb-compile-rebuild.md` lines 84–92: importing `SourceFrontmatter` from `kdb_compiler/compiler.py`.
...
*   **Evidence:** `docs/superpowers/archive/plans/2026-05-29-task91-plan1-kdb-compile-rebuild.md` lines 175–188.
...
*   **Evidence:** `docs/superpowers/archive/plans/2026-05-29-task91-plan1-kdb-compile-rebuild.md` lines 375–378.
