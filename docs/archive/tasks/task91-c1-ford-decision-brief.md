...
Read for context: `docs/superpowers/archive/plans/2026-05-29-task91-plan5-6-orchestrator-loop.md`, `docs/task91-plan5-6-review-synthesis.md`, spec `docs/superpowers/archive/specs/2026-05-28-kdb-orchestrate-e2e-design.md` (Orchestrator loop, Pass-1 egress), `docs/task91-kdb-orchestrate-blueprint.md` (esp. **D-91-13** two-phase failure model), and code: `graphdb_kdb/ingestor.py` (`apply_compile_result`, `_replace_outgoing_links`, `detect_orphans`), `graphdb_kdb/rebuilder.py::rebuild`.
