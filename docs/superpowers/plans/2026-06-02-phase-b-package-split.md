...
- [ ] **Step 5: On clean run-7 — Phase B is DONE.** Record the gate result in `docs/RELEASES.md`/daily note; merge `refactor/phase-b-package-split`; tag (e.g. `v0.5.2`). **Then #106** (panel-review the spec → writing-plans → run-8).
