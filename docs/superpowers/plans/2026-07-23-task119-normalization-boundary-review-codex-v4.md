...
- **Governing blueprint:** `docs/superpowers/specs/2026-07-23-task119-normalization-boundary-blueprint.md` v0.3
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:656`

In practice, slugs, summary identity, and bodies are still mutated directly alongside operation recording:

- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:851`
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:924`
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:973`
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1137`
...
- `docs/superpowers/specs/2026-07-23-task119-normalization-boundary-blueprint.md:1`
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1834`
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1604`
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1517`
...
- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1450`

The `compile_source` test calls undefined `_conn(tmp_path)` and refers to a nonexistent `kdb_graph.testing` helper:

- `docs/superpowers/plans/2026-07-23-task119-normalization-boundary.md:1582`
