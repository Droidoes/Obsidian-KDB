...
### [Severity: High] · spec §3 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:44-48`; code `compiler/validate_source_response.py:58-97`
...
### [Severity: High] · spec §2/§5 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:38,83`; code `compiler/compiler.py:305-337`
...
### [Severity: Medium] · spec §4a/§5 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:57-59,83`; code `common/paths.py:63-71`, `compiler/validate_compile_result.py:232-255`
...
### [Severity: Medium] · spec §4c / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:73-74`
...
### [Severity: Low] · spec §4b / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:69`; code `compiler/schemas/compiled_source_response.schema.json:29-31,99-113`
...
### [Severity: High] · spec §5 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:80-83`; code `compiler/compiler.py:322-347`
...
### [Severity: Medium] · spec §4b / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:68`; code `compiler/validate_source_response.py:100-124`, `compiler/repair.py:153-176`, `compiler/canonicalize.py:308-333`
...
### [Severity: Low] · spec §8 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:105-112`; code `docs/CODEBASE_OVERVIEW.md`
...
### [Severity: Medium] · spec §7 / `docs/superpowers/archive/specs/2026-06-02-json-repair-slug-coercion-ladder-design.md:95-101`; code `common/types.py:406-428`, `common/llm_telemetry.py:146-176`
