...
`docs/superpowers/archive/specs/2026-06-10-graph-access-package-design.md`) needs a named,
...
READ (do not modify):
  docs/superpowers/archive/specs/2026-06-10-mcp-killer-app-challenge.md
