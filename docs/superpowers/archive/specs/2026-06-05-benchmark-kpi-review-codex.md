...
[Severity: High] brief §2C row `BELONGS_TO coverage` (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:73-81`); `kdb_graph/ingestor.py:488-544`; `ingestion/enrich/pass1_schema.py:73-78`
...
[Severity: High] brief §2A processing robustness rows (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:51-58`); `compiler/compiler.py:289-303`; `compiler/compiler.py:480-491`; `tools/benchmark/scorer.py:384-393`
...
[Severity: Critical] brief §2C row `link-resolution / dangling-link rate` and §3 M1 migration (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:73`; `docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:96`); `kdb_graph/ingestor.py:316-337`; `kdb_graph/queries.py:310-319`; `tools/benchmark/scorer.py:221-255`
...
[Severity: Medium] brief §3 M5 kill rationale (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:94`); `compiler/repair.py:242-265`; `kdb_graph/ingestor.py:330-337`; `compiler/validate_source_response.py:115-124`
...
[Severity: Low] old M2/M3 kill (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:92-93`); `compiler/repair.py:268-306`; `compiler/validate_compile_result.py:180-230`
...
[Severity: High] brief §4 fork 5 (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:111`); `kdb_graph/ingestor.py:347-393`; `kdb_graph/queries.py:155-173`
...
[Severity: Medium] brief §2C row `orphan rate` (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:75`); `kdb_graph/ingestor.py:649-702`; `orchestrator/kdb_orchestrate.py:195-209`; `tools/cleanup.py:117-161`
...
[Severity: Medium] brief §4 fork 4 normalization (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:109`)
...
[Severity: High] brief §4 fork 1 (`docs/superpowers/archive/specs/2026-06-05-benchmark-kpi-enumeration-brief.md:103`); `ingestion/enrich/enrich.py:132-150`; `ingestion/enrich/enrich.py:193-217`; `ingestion/enrich/replay_archive.py:22-43`; `orchestrator/kdb_orchestrate.py:610-674`
