...
**Spec:** `docs/superpowers/archive/specs/2026-06-07-optimal-model-calls-design.md` §3a (#111 Phase 0). Branch `feat/111-structured-output-upgrade` (currently at `v0.5.4`/`d41da4a`).
