...
**Spec:** `docs/superpowers/archive/specs/2026-06-07-optimal-model-calls-design.md` §6c (native Gemini handler), pulled forward into Phase 1 per the 2026-06-07 decision (native path is Gemini's real upgrade; `json_schema` stays isolated to Phase 2). Branch: continue on `feat/111-phase1`.
