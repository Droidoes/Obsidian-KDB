...
**Spec:** `docs/superpowers/archive/specs/2026-06-07-optimal-model-calls-design.md` §4 (Phase 1) + §5 (Checkpoint A). Branch: continue on `feat/111-structured-output-upgrade` (currently merged to `main` at `v0.5.5`/`f82ca4c`) — cut a fresh `feat/111-phase1` off `main` if you prefer isolation.
