...
**Specs:** B1 `docs/superpowers/archive/specs/2026-06-05-passcallmeasurement-design.md` · B2 `…task108-pass1-robustness-design.md` · B3 `…benchmark-framework-design.md` · KPI list `…benchmark-kpi-enumeration-brief.md`.
