...
Start by reading the checkpoint doc — it has the full context, the per-phase build record, and the specific questions:
  docs/superpowers/archive/plans/2026-07-24-task119-phase3-execution-checkpoint-kimi.md
...
2. Drift: compare the ratified architecture (blueprint v0.4 in docs/superpowers/archive/specs/2026-07-23-task119-normalization-boundary-blueprint.md) against the real code in compiler/proposal_bridge.py and the rewired block in compiler/compiler.py — retry semantics, §3.5 truth table, conservation, telemetry capping.
...
Verdict format: GO or REVISE, with numbered findings (severity: Critical/Important/Minor, each with file:line and a concrete fix). Write your review to:
  docs/superpowers/archive/plans/2026-07-24-task119-phase3-execution-checkpoint-review-codex.md
