...
**Spec:** `docs/superpowers/archive/specs/2026-05-28-kdb-orchestrate-e2e-design.md` — "Orphan-marking is deferred to end-of-run". Plan 2 of 6. Leaves the app green (default `True` = unchanged behavior; existing orphan tests still pass).
