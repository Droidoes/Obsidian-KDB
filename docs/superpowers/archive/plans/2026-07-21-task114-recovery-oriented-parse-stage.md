...
**Goal:** Make the Pass-2 parse stage recover the JSON payload from any carrier noise (select, never edit; fail only when no complete document exists) — spec v0.3.6 at `docs/superpowers/archive/specs/2026-07-21-recovery-oriented-parse-stage-design.md`.
