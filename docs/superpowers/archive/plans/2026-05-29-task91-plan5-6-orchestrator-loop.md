...
**Spec:** `docs/superpowers/archive/specs/2026-05-28-kdb-orchestrate-e2e-design.md` (Orchestrator loop + Pass-2 ingress + Pass-1 egress). **Decisions:** D-91-1..14; embed-during-enrich + post-embed-hash (2026-05-29); produce-don't-write + accept cross-source-wiki trade-off (panel forks). Plans 5+6 of 6.
