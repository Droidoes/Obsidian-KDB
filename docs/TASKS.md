...
| 32 | open          | Benchmark corpus v1 (`benchmark/sources/`)                    | Surfaced 2026-05-06. Curate 5 license-clean public sources: (1) Attention Is All You Need (arXiv 1706.03762v7, ar5iv→pandoc), (2) Distill "Why Momentum Really Works" (CC-BY-4.0), (3) The Twelve-Factor App (CC-BY-4.0), (4) Distill "Research Debt" (CC-BY-4.0), (5) Rust Book "Understanding Ownership" (MIT/Apache-2.0). Each source committed alongside a `.meta.yaml` (URL, version, license, conversion command, sha256, conversion date). Total ~28K source words; ~$1.70 per scorecard for haiku-4.5 + sonnet-4.6. Per `feedback_no_imaginary_risk` — keep it small, deterministic, repeatable |
