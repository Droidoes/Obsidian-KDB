...
| 19 | in-progress   | Define KPIs + gate thresholds for KDB benchmark               | Phase 2 + Round 3 (Codex-driven) closed 2026-05-04; weights locked S0=20/M1=20/M2=5/M3=5/M4=15/M5=5/M6=15/M7=15. **Phase 3 fully unblocked** — #28 closed at `0bcc2b6`, #29 closed at `26b345a`. See `docs/task19-kpi-design.md`, companion `task19-kpi-design-codex-feedback-take-1.md` |
