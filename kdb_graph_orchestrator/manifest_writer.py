...
strip (removes pages{}, orphans{}, page-derived stats). The kdb_graph_orchestrator
...
def apply_source_failure(
    ...
    *,
    ...
    Used by the kdb_graph_orchestrator quarantine path. The scan reconciliation records
