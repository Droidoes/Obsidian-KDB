...
def build_resp_stats(
    *,
    ...
    normalization_decisions: list | None = None,
    normalization_decision_count: int | None = None,
    normalization_decisions_overflow_sha256: str | None = None,
    ...
    return RespStatsRecord(
        ...
        normalization_decision_count=normalization_decision_count,
        normalization_decisions_overflow_sha256=normalization_decisions_overflow_sha256,
        summary_identity_derived=summary_identity_derived,
        boundary_recovered=boundary_recovered,
        prefix_discarded_chars=prefix_discarded_chars,
        tail_discarded_chars=tail_discarded_chars,
