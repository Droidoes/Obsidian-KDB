...
shared dataset (tests/fixtures/wikilink_parity/cases.json) as the kdb_graph_compiler
consumers (kdb_graph_compiler/tests/test_wikilink_parity.py). kdb_graph imports no
