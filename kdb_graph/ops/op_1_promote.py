...
from kdb_graph.core.belief_classifier import (
    CandidateEnvelope,
...
def run(candidate: CandidateEnvelope, eval_config: EvalConfig, conn: Any) -> PromotionResult:
    ...
    """
    from kdb_graph.core.belief_classifier import classify
...
def _verify_post_mutation(
    ...
    function is a no-op.
    """
    from kdb_graph.core.belief_classifier import _scope_key
